	...
	return (
		<div>
			<div className="text-center">
				<h1 className={clsx(title(), "text-transparent bg-clip-text bg-gradient-to-br from-violet-400 to-indigo-600")}>About Us</h1>
			</div>
			<>
				{/* Team */}
					...
					<div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
						<div className="flex flex-col rounded-xl p-4 md:p-6 bg-white border border-gray-200 dark:bg-slate-900 dark:border-gray-700">
							<div className="flex items-center gap-x-4">
								<img
									...
									src="https://media.discordapp.net/attachments/940015266820141108/1140037435615621150/91755541_p0.jpg?width=670&height=670"
						...
						<div className="flex flex-col rounded-xl p-4 md:p-6 bg-white border border-gray-200 dark:bg-slate-900 dark:border-gray-700">
							<div className="flex items-center gap-x-4">
								<img
									className="rounded-full w-20 h-20"
									src="https://images-ext-1.discordapp.net/external/LOUnud2ZLcwtS1tCCsPrqjoTBGWMCp93N1vZzfPlzps/https/cdn.discordapp.com/avatars/782998240081084416/35a2f15217fda10d74149733f6c5a988.webp?width=160&height=160"
									alt="Image Description"
								/>
								<div className="grow">
									<h3 className="font-medium text-gray-800 dark:text-gray-200">
						...
						<div className="flex flex-col rounded-xl p-4 md:p-6 bg-white border border-gray-200 dark:bg-slate-900 dark:border-gray-700">
							<div className="flex items-center gap-x-4">
								<img
									className="rounded-full w-20 h-20"
									src="https://images-ext-1.discordapp.net/external/3-zL2eC8aBsGf46mZEI3BIudJBimW7Io03JZLgg-DKo/https/cdn.discordapp.com/avatars/981369355600298015/8a945cb3058bd08de2d692d21c8dd34a.webp?width=160&height=160"
									alt="Image Description"
								/>
								<div className="grow">
									<h3 className="font-medium text-gray-800 dark:text-gray-200">
